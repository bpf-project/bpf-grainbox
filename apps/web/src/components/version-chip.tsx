/**
 * <VersionChip /> — small, discoverable label for the Grainbox build and
 * deploy date. Click → GitHub release notes.
 *
...
export function VersionChip({
  ...
  return (
    <a
      ...
      title={`Grainbox ${RELEASE.version} · released ${RELEASE.releaseDate} · click for release notes`}
